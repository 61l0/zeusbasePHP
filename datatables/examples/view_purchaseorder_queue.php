<?php
    ...
    $sIndexColumn = "PO_HeaderId";

    /* DB table to use */
    $sTable = "[Tracking].[dbo].[Translator_PurchaseOrder_Queue]";
    ...
    */
 	$aColumns = array( 'PO_HeaderId', 'PO_Number', 'PO_Date', 'LoginID', 'Status', 'Reference', 'Voyage', 'Consignee' );    
