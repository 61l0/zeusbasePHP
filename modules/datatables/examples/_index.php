...
<div id="sidebar">
    <div class="mainNav">
        ...
        <ul class="nav">
            ...
            <li><a href="tables.html" title="" class="active"><img src="images/icons/mainnav/tables.png" alt="" /><span>Tables</span></a>
                <ul>
        ...
        <div class="secWrapper">
            ...
            <div id="tab-container" class="tab-container">
                <ul class="iconsLine ic2 etabs">
                    ...
                    <li><a href="#somestuff" title=""><span class="icos-users"></span></a></li>
                </ul>
                ...
                <div id="general">
                    <ul class="subNav">
                        <li><a href="tables.html" title=""><span class="icos-frames"></span>Standard tables</a></li>
                        <li><a href="tables_dynamic.html" title="" class="this"><span class="icos-refresh"></span>Dynamic table</a></li>
                ...
                <div id="somestuff">
                    <div class="widget">
                        <div class="whead"><h6><span class="icon-tree-view"></span>Simple jQuery file tree</h6></div>
...
<div id="content">
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            <div class="whead"><h6>MSSQL DEMO</h6></div>
	            <div id="dyn3" class="hiddenpars">
	                <a class="tOptions" title="Options"><img src="images/icons/options" alt="" /></a>	
					 <table cellpadding="0" cellspacing="0" border="0"  id="mssqlDemo">		
						<thead>
							<tr>
								<th>ShipmentId</th>
								<th>FileNumber</th>
        ...
        <div class="widget">
            <div class="whead"><h6>MSSQL PROCESS</h6></div>
	            <div id="dyn4" class="hiddenpars">    				
		           	 <a class="tOptions" title="Options"><img src="images/icons/options" alt="" /></a>	
					 <table cellpadding="0" cellspacing="0" border="0"  id="mssqlProcess">		
							<thead>
								<tr>
									<th>ShipmentId</th>
									<th>FileNumber</th>
...
$(document).ready(function() {
		    ...
		    $('#mssqlDemo').dataTable( {
				...
				"oLanguage": {
					"sLengthMenu": "<span class='showentries'>Show Shipments:</span> _MENU_"
				},
				"sDom": '<"tablePars"fl>tr<"tableFooter"ip>'	
				
		    });	
		    
		    $('#mssqlProcess').dataTable( {
		        "bProcessing": true,
		        "bServerSide": true,
		        "sAjaxSource": "php/server_processing_mssql.php",
		        "aoColumns": [
		            { "sName": "ShipmentId" },
		            { "sName": "FileNumber" },
		            { "sName": "MasterNumber" },
			...
			// all
			$('#dyn3 .tOptions').click(function () {
				$('#dyn3 .tablePars').slideToggle(200);
			});	
			
			$('#dyn4 .tOptions').click(function () {
				$('#dyn4 .tablePars').slideToggle(200);
			});				
