...
$opts = array(
	...
	'roots' => array(
		array(
			...
			'path'       => dirname(__FILE__).DIRECTORY_SEPARATOR.'../../../cms/uploads/albums/',
			'startPath'  => dirname(__FILE__).DIRECTORY_SEPARATOR.'../../../cms/uploads/albums/',
			'URL'        => dirname($_SERVER['PHP_SELF']) . '/../../../cms/uploads/albums/',			
		    'alias'      => 'Album Photos',
			'mimeDetect' => 'internal',
			'utf8fix'    => true,
			'accessControl' => 'access',
			'acceptedName'    => '/^[^\.].*$/',
		    'disabled' => array('extract', 'archive', 'rename', 'duplicate', 'cut', 'copy', 'paste', 'mkdir', 'help', 'mkfile', 'download', 'back', 'forward', 'rm', 'upload'),			
			'attributes' => array(
				array(
					'pattern' => '/\.js$/',
					'read' => true,
