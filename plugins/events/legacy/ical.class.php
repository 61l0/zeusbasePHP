<?php
/**
 * This PHP-Class should read ICS data, parse it and give an 
 ...
 * @example  $ical = new ical([data here]);
 *           print_r( $ical->events() );
 */
...
/**
 * This is the (MODIFIED) iCal-class
 *
 * @category Parser
 * @package  Ics-parser
 * @author   Martin Thoma <info@martin-thoma.de>
 ...
 * @link     http://code.google.com/p/ics-parser/
 *
 * @param {string} the data that should be parsed
 * @constructor
 */
class ICal
{
